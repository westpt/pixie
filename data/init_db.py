...
def init_database(reset=False):
    ...
    try:
        ...
        print("扩展agents表，添加岗位和技能字段...")
        cursor.executescript(AGENTS_EXTENDED_COLUMNS_SCHEMA)
        ...
        print("创建roles表...")
        cursor.executescript(ROLES_TABLE_SCHEMA)

        print("创建agent_roles表...")
        cursor.executescript(AGENT_ROLES_TABLE_SCHEMA)
...
def verify_database():
    ...
    try:
        # 检查表是否存在
        required_tables = ['agents', 'tasks', 'results', 'config_history', 'roles', 'agent_roles']
